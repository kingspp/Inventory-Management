...
<head>
	...
	<%@include file="html/definitions/cssDefinitions.html"%>
...
<section class="section">
	...
	<div class="container">
		<div class="row tab">
			...
			<%@include file="html/user/imUserController.html"%>
			<%@include file="html/inventory/imInventoryController.html"%>
...
<!-- modals -->
<!-- Modal Structure -->
<%@include file="html/user/userModal.html" %>
<%@include file="html/inventory/inventoryModal.html" %>

<%@include file="html/footer.html" %>
<%@include file="html/definitions/jsDefinitions.html"%>
</body>
</html>