...
public class UserController {
    ...
    @RequestMapping( value = "/insertUser", method = RequestMethod.POST ,headers = "content-type=multipart/*")
    public @ResponseBody
    ...
    public @ResponseBody
    String removeUser(@PathVariable Integer userId) throws Exception
    {
        try
        {
